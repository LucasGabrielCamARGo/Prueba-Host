...
function online_tutor_getpage_css($hook) {
	wp_enqueue_script( 'online-tutor-admin-script', get_template_directory_uri() . '/inc/admin/js/online-tutor-admin-notice-script.js', array( 'jquery' ) );
    wp_localize_script( 'online-tutor-admin-script', 'online_tutor_ajax_object',
...
define('ONLINE_TUTOR_FREE_DOC',__('https://www.themagnifico.net/eard/wathiqa/online-tutor-pro-doc/','online-tutor'));
}
