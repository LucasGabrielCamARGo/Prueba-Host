...
(function( $ ) {
	wp.customize.bind( 'ready', function() {
		...
		function online_tutor_customizer_label( id, title ) {
			...
			if ( id === 'online_tutor_preloader_hide' || id === 'online_tutor_sticky_header' || id === 'online_tutor_scroll_hide' || id === 'online_tutor_products_per_row' || id === 'online_tutor_scroll_top_position') {
