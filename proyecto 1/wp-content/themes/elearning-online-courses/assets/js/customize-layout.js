...
(function( $ ) {
	wp.customize.bind( 'ready', function() {
		...
		function online_tutor_customizer_label( id, title ) {
			...
			if ( id === 'online_tutor_preloader_hide' || id === 'online_tutor_sticky_header' || id === 'online_tutor_scroll_hide' || id === 'online_tutor_scroll_top_position' || id === 'online_tutor_products_per_row') {
			...
			if ( id === 'online_tutor_ticket_text' || id === 'elearning_online_courses_admission' || id === 'elearning_online_courses_research' || id === 'elearning_online_courses_faq' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'online_tutor_footer_bg_image' || id === 'online_tutor_show_hide_copyright') {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
		...
		online_tutor_customizer_label( 'online_tutor_scroll_top_position', 'Scroll to top Position' );
		online_tutor_customizer_label( 'online_tutor_products_per_row','Woocommerce Settings');
		online_tutor_customizer_label( 'online_tutor_woocommerce_product_sale', 'Woocommerce Product Sale Positions' );
		online_tutor_customizer_label( 'online_tutor_woo_product_border_radius', 'Woocommerce Product Border Radius' );
		...
		//Footer
		online_tutor_customizer_label( 'online_tutor_footer_bg_image', 'Footer' );
